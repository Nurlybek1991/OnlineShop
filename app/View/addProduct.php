        ...
        <div class="form">
            ...
            <form id="form" method="POST" action="/addProduct">
                <div class="inputWrapper">
                    ...
                    <input type="text" name="product_id" id="productId" required />
                    <?php if (isset($errors['product_id'])): ?>
                        <label style="color: red"><?php echo $errors['product_id']; ?></label>
                    <?php endif; ?>
                    <label for="first">Продукты</label>

                </div>
                <div class="inputWrapper">
                    <input type="text" name="quantity" id="quantity" required />
                    <label for="last">Количество</label>
                    <?php if (isset($errors['quantity'])): ?>
                        <label style="color: red"><?php echo $errors['quantity']; ?></label>
                    <?php endif; ?>
                </div>
            </form>
            <input form="form" type="submit" name="addProduct" id="register" value="Добавление продуктов" />
            <span id="login">Do u want Main? <a href="/main" title="Main">Main</a></span>
        </div>
    </div>
</main>
</body>
